...
$def[3] .= "GPRINT:rxrate:LAST:'%7.2lf last' ";
$def[3] .= "GPRINT:rxrate:AVERAGE:'%7.2lf avg' ";
$def[3] .= "GPRINT:rxrate:MAX:'%7.2lf max' ";
$def[3] .= "GPRINT:rxrate:MIN:'%7.2lf min'\\n ";
$def[3] .= "LINE1:txrate{$_C_TXRATE}:'tx' ";
$def[3] .= "GPRINT:txrate:LAST:'%7.2lf last' ";
$def[3] .= "GPRINT:txrate:AVERAGE:'%7.2lf avg' ";
$def[3] .= "GPRINT:txrate:MAX:'%7.2lf max' ";
$def[3] .= "GPRINT:txrate:MIN:'%7.2lf min'\\n ";
...
$def[4] .= "GPRINT:users:MAX:'%7.2lf max' ";
$def[4] .= "GPRINT:users:MIN:'%7.2lf min'\\n ";
