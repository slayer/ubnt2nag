...
$def[3] .= "GPRINT:rxrate:LAST:'%7.2lf Mbit/s last' ";
$def[3] .= "GPRINT:rxrate:AVERAGE:'%7.2lf Mbit/s avg' ";
$def[3] .= "GPRINT:rxrate:MAX:'%7.2lf Mbit/s max' ";
$def[3] .= "GPRINT:rxrate:MIN:'%7.2lf Mbit/s min'\\n ";
$def[3] .= "LINE1:txrate{$_C_TXRATE}:'tx' ";
$def[3] .= "GPRINT:txrate:LAST:'%7.2lf Mbit/s last' ";
$def[3] .= "GPRINT:txrate:AVERAGE:'%7.2lf Mbit/s avg' ";
$def[3] .= "GPRINT:txrate:MAX:'%7.2lf Mbit/s max' ";
$def[3] .= "GPRINT:txrate:MIN:'%7.2lf Mbit/s min'\\n ";
...
$def[4] .= "GPRINT:users:LAST:'%7.2lf %S users last' ";
$def[4] .= "GPRINT:users:AVERAGE:'%7.2lf %S users avg' ";
$def[4] .= "GPRINT:users:MAX:'%7.2lf users max' ";
$def[4] .= "GPRINT:users:MIN:'%7.2lf users min'\\n ";
...
$def[5] .= "GPRINT:lavg:LAST:'%7.2lf %S ps last' ";
$def[5] .= "GPRINT:lavg:AVERAGE:'%7.2lf %S ps avg' ";
$def[5] .= "GPRINT:lavg:MAX:'%7.2lf ps max' ";
$def[5] .= "GPRINT:lavg:MIN:'%7.2lf ps min'\\n ";
...
$def[6] .= "GPRINT:days:LAST:'%7.2lf days last' ";
$def[6] .= "GPRINT:days:AVERAGE:'%7.2lf days avg' ";
$def[6] .= "GPRINT:days:MAX:'%7.2lf days max' ";
